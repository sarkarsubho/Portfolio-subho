    ...
    return (
        <div className="navbar">
            <div className="navbar--container">
                <h1 style={{color:"white"}}>Subhankar Sarkar</h1>
            ...
            >
                ...
                <div onClick={handleDrawerClose} >
                    <div className="navLink--container">
                        ...
                        <Fade left>
                            <NavLink to="/#educaton" smooth={true} spy="true" duration={2000}  style={{ textDecoration: "none"}}>
                                <div className={classes.drawerItem}>
                        ...
                        <Fade left>
                            <NavLink to="/#skill" smooth={true} spy="true" duration={2000}  style={{ textDecoration: "none"}}>
                                <div className={classes.drawerItem}>
                        ...
                        <Fade left>
                            <NavLink to="/#experience" smooth={true} spy="true" duration={2000}  style={{ textDecoration: "none"}}>
                                <div className={classes.drawerItem}>
                                    <FaFantasyFlightGames className={classes.drawerIcon}/>
                                    <span className={classes.drawerLinks}>Exprience</span>
                                </div>
                            </NavLink>
                        </Fade>
