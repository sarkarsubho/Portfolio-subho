            ...
            <div className="contacts--container">
                ...
                <div className="contacts-body">
                    ...
                    <div className="contacts-details">
                        <a  href={`mailto:${contactsData.email}`} className="personal-details"  style={{ textDecoration: "none"}}>
                            <div className={classes.detailsIcon}>
                                <FiAtSign />
                            </div>
                            <p style={{color:theme.tertiary}}>{contactsData.email}</p>
                        </a>
                        <a href={`tel:${contactsData.phone}`} className="personal-details"  style={{ textDecoration: "none"}}>
                            <div className={classes.detailsIcon}>
                                <FiPhone/> 
                            </div>
