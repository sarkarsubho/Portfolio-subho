                ...
                <div className="landing--container-left" style={{ backgroundColor: theme.primary}}>
                    <div className="lcl--content">
                        {socialsData.linkedIn && (
                            <a href="https://www.linkedin.com/in/dev-subhankar-sarkar/" target="_blank" rel="noreferrer">
                                <FaLinkedin className="landing--social" style={{color: theme.secondary}}/>
                            </a>
                        )}
                        {socialsData.github && (
                            <a href="https://github.com/sarkarsubho" target="_blank" rel="noreferrer">
                    ...
                    <div className="lcr--content" style={{color: theme.tertiary}}>
                        ...
                        <div style={{position:"relative",margin:"10% auto",width:"70%",marginBottom:"10%"}} className="lcr-buttonContainer">
                            <div style={{marginBottom:"30px"}}>
                                ...
                                <a href="https://drive.google.com/drive/u/0/folders/1Ga-h8YK25ywp_yCqRF_oDSPWmMepD2ei" download="resume" target="_blank" rel="noreferrer"  style={{ textDecoration: "none"}}>
